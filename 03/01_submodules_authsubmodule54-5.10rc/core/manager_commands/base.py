...
class BaseCommand(Command):
    ...
    @staticmethod
    def _listdir_no_hidden(path: str) -> Generator[str, None, None]:
        """
    ...
    @staticmethod
    def _clean_and_sort(
        files_list: Union[Generator[str, None, None], list], actions: bool = False
    ) -> List[str]:
        """
    ...
    def _get_path(folder_name: str) -> List[str]:
        ...
        for root, dirs, files in os.walk("."):
            if folder_name in dirs:
                if root == ".":
                    files_paths.append(root.lstrip("./") + folder_name)
                else:
                    files_paths.append(root.lstrip("./") + "/" + folder_name)
        return files_paths
