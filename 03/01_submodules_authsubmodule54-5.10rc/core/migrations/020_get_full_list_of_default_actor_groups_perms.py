...
class Migration(base.BaseMigration):
    ...
    forwards_query = """
        ...
        CREATE OR REPLACE FUNCTION standalone_collect_full_list_of_actor_perms(actor_uuid uuid, OUT result jsonb)
            RETURNS jsonb
            LANGUAGE plpgsql
            STRICT
        AS $function$
        ...
        DROP FUNCTION IF EXISTS standalone_collect_full_list_of_groups_perms CASCADE;
        
        CREATE OR REPLACE FUNCTION standalone_collect_full_list_of_groups_perms(actor uuid, OUT result jsonb)
            RETURNS jsonb
            LANGUAGE plpgsql
            STRICT
        AS $function$
        ...
        DROP FUNCTION IF EXISTS standalone_collect_full_list_of_default_perms CASCADE;

        CREATE OR REPLACE FUNCTION public.standalone_collect_full_list_of_default_perms(actor uuid, OUT result jsonb)
            RETURNS jsonb
            LANGUAGE plpgsql
            STRICT
        AS $function$
        ...
        DROP FUNCTION IF EXISTS standalone_collect_full_list_of_compiled_actor_perms CASCADE;
        
        
        CREATE OR REPLACE FUNCTION public.standalone_collect_full_list_of_compiled_actor_perms(actor_uuid uuid, OUT result jsonb)
            RETURNS jsonb
            LANGUAGE plpgsql
            STRICT
        AS $function$
        ...
        DROP FUNCTION IF EXISTS standalone_collect_full_list_of_default_actor_groups_perms CASCADE;
        
        CREATE OR REPLACE FUNCTION public.standalone_collect_full_list_of_default_actor_groups_perms(actor uuid)
        ...
        BEGIN
            ...
            standalone_collect_full_list_of_default_perms(actor), 'actor', standalone_collect_full_list_of_actor_perms(actor), 
            'groups', standalone_collect_full_list_of_groups_perms(actor), 'compiled', 
            standalone_collect_full_list_of_compiled_actor_perms(actor));
        END $function$;
        """

    backwards_query = f"""
        DROP FUNCTION standalone_collect_full_list_of_actor_perms;
        DROP FUNCTION standalone_collect_full_list_of_groups_perms;
        DROP FUNCTION standalone_collect_full_list_of_default_perms;
        DROP FUNCTION standalone_collect_full_list_of_compiled_actor_perms;
        DROP FUNCTION standalone_collect_full_list_of_default_actor_groups_perms;
    """
